...
gmx_gpu_mpi mdrun -s prod.tpr -nstlist 200 -deffnm prod -multidir {0..19} -plumed ./plumed.dat -replex 800 -hrex -dlb no -pin on -ntomp 2 -nb gpu -pme gpu -pmefft gpu -bonded gpu -tunepme no -v 
